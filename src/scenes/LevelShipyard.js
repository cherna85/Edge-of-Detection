class LevelShipyard extends LevelBase {
    ...
    createButtons(){
        ...
        createSpotlights( mappedObjects){
            ...
            let ray = this.levelLOS.createConeArray(this, this.follower.vec.x, this.follower.vec.y, this.degree, 180, 200);
            let ray2 = this.levelLOS.createConeArray(this, this.follower.vec.x, this.follower.vec.y, this.degree+180, 180, 200);
