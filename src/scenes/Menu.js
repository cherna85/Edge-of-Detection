class Menu extends Phaser.Scene {
        ...
        create(){
            ...
            sceneSelect = 'levelShipyard'; //reinitalize menu
        ...
        update(time, delta){
            ...
            if (Phaser.Input.Keyboard.JustDown(keyDown)) {
                if(sceneSelect == 'levelShipyard'){
                    ...
                    this.updateMenu(this.creditsbutton, this.playbutton, "levelShipyard");
                }
                }
            if (Phaser.Input.Keyboard.JustDown(keyUp)) {
                if(sceneSelect == 'levelShipyard'){
                    ...
                    this.updateMenu(this.lsbutton, this.playbutton, 'levelShipyard');
                }  
                else if(sceneSelect == "optionsScene"){
